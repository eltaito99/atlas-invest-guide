    ...
    const fetchFinancialData = async () => {
      ...
      try {
        ...
        toast({
          ...
          description: `Real-time financial data for ${symbol}`,
        });
      } catch (error) {
        ...
        const fallbackData = getCompanyData(symbol);
        setFinancialData({
          symbol: symbol,
          ...fallbackData
        });
        ...
        toast({
          ...
          description: "Real-time data unavailable, showing sample data for " + symbol,
          variant: "destructive"
        });
      } finally {
        setLoading(false);
